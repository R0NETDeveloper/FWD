namespace Custom.InputAccel.UimScript
{
    ...
    class ScriptidCard : UimScriptDocument
    {
        public static ArrayList prelist;
        IUimDataEntryFormContext getFrom;
        ...
        public void FormLoad(IUimDataEntryFormContext form)
        {
            try
            {
                ...
                //Lookup parameter
                getFrom = form;
                //m.Lookup(form.FindControl(form.FormName), getFrom, "FormLoad");
